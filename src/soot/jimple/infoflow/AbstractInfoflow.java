...
public abstract class AbstractInfoflow implements IInfoflow {
	...
	public boolean computeInfoflow(String appPath, String libPath,
		...
		return this.computeInfoflow(appPath, libPath, entryPointCreator,
	...
	public boolean computeInfoflow(String appPath, String libPath,
		...
		return this.computeInfoflow(appPath, libPath, new DefaultEntryPointCreator(entryPoints),
				new DefaultSourceSinkManager(sources, sinks));
	}

	@Override
	public boolean computeInfoflow(String libPath, String appPath,
			String entryPoint, Collection<String> sources, Collection<String> sinks) {
		return this.computeInfoflow(appPath, libPath, entryPoint, new DefaultSourceSinkManager(sources, sinks));
	}
